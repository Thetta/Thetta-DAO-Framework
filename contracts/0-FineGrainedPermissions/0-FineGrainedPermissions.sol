...
////
	constructor(IDaoBase _dao) public DaoClient(_dao){
		// 1 - create tokens 
		tokenGovernance = new StdDaoToken("YourDaoGovToken","GOV",18, true, true, 1e9);
		tokenReputation = new StdDaoToken("YourDaoRepToken","REP",18, true, true, 1e9);
		tokenReputationDev = new StdDaoToken("YourDaoRepDevToken","REPD",18, true, true, 1e9);
